...
\begin{figure}[H]
    ...
    libera sus recursos sin interrumpir al otro. El minero de 8 segundos detecta inmediatamente que se ha quedado solo (0 votos esperados).
     En lugar de quedarse colgado esperando un \texttt{SIGUSR2} que nunca llegará, el sistema sigue funcionando y auto-aprueba las rondas (\texttt{[ ] -> Accepted}). 
...
\textbf{Pregunta a) ¿Se produce algún problema de concurrencia en el sistema descrito?}


\textbf{Pregunta b) ¿Cómo se ha solucionado en el planteamiento dado?}


\textbf{Pregunta c) ¿Es sencillo, o siquiera factible, organizar un sistema de este tipo usando únicamente señales?}


\textbf{Pregunta d) ¿Cuáles son los mineros que tienden a ganar más monedas? (mostrar casos de
ejecución que corroboren la respuesta)?}
